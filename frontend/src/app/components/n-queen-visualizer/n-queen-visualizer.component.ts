...
// == This component visualizes the N-Queens problem using a chessboard Layouts ====
export class NQueenVisualizerComponent implements OnInit {
  ...
  // === This function checks if the current positin of the queen is valid or not ===
  ...
  // === This function clears the color of the cells in the chessboard ===
  ...
  // === This function is the main recursive function that solves the N-Queens problem ===
  async solveQueen(
    board: number,
    r: number,
    n: number
  ...
  // === This function initializes the N-queens problem and statrs solving ====
  ...
  // === This function visualizes the N-Queens problem by creating a chessboard and placing queens ===
  async visualize(): Promise<void> {
    ...
    // ======   Here it will Create the boards ========
    ...
    // Initialize the boards and then start traversing
