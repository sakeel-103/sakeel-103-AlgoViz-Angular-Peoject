...
export class QuestionBankComponent implements OnInit {
  questions: Question[] = [
    ...
    },
    {
      ...
      description:
        'Implement the representation of a graph using an adjacency matrix.',
    ...
    },
    {
      ...
      description:
        'Check if a graph contains a negative weight cycle using Bellman-Ford algorithm.',
    ...
    },
    {
      ...
      description:
        'Determine the minimum number of colors required to color a graph such that no two adjacent vertices have the same color.',
    ...
    },
    {
      ...
      description:
        'Find the shortest path between a source node and all other nodes in a weighted graph using Dijkstra’s algorithm.',
    ...
    },
    {
      ...
      description:
        'Find all strongly connected components in a directed graph using Tarjan’s or Kosaraju’s algorithm.',
    ...
    },
    {
      ...
      description:
        'Find the diameter of a graph, which is the longest shortest path between any two vertices.',
    ...
    },
    {
      ...
      description:
        'Find the articulation points (cut vertices) in an undirected graph.',
      link: 'https://www.geeksforgeeks.org/articulation-points-or-cut-vertices-in-a-graph/',
      level: 'Medium',
    },
    {
  ...
  isMobile: boolean = window.innerWidth <= 576; // Added to support responsive dropdown
      ...
      this.filteredQuestions = this.questions.filter(
        (question) =>
          (this.selectedCategory === '' ||
            question.level === this.selectedCategory) && // Use 'level' to match Question interface
          (question.title
            .toLowerCase()
