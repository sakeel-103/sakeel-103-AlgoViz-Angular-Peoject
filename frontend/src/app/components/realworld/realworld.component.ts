  ...
  applications: Application[] = [
    {
      ...
      description:
        'Graph theory is used to analyze social networks, where nodes represent individuals and edges represent relationships or interactions.',
      icon: '👥',
      category: 'Technology',
      details: [
    ...
    },
    {
      ...
      description:
        'Graphs model road networks, flight paths, and public transit systems, optimizing routes and traffic flow.',
      icon: '🚗',
    ...
    },
    {
      ...
      description:
        'Network topologies and data routing algorithms rely heavily on graph theory concepts.',
      icon: '💻',
      category: 'Technology',
      details: [
