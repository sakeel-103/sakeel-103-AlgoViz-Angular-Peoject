...
export class AlgorithmLibraryPageComponent implements OnInit {
  ...
  while (queue.length > 0) {
    ...
    },
    {
      ...
      description:
        'An algorithm that finds the shortest paths between nodes in a graph with non-negative weights.',
  ...
  return distances;
    ...
    },
    {
      ...
      description:
        'An informed search algorithm that finds the shortest path by considering both cost and heuristic.',
  ...
  return mst;
    ...
    },
    {
      ...
      description:
        'An algorithm that finds the minimum spanning tree by sorting all edges.',
  ...
  return mst;
    ...
    },
    {
      name: 'Merge Sort',
      description:
        'A divide and conquer algorithm that splits the list into halves and merges them in sorted order.',
...
function merge(left, right) {
  ...
  return result.concat(left.slice(i)).concat(right.slice(j));
    ...
    },
    {
      name: 'Quick Sort',
      description:
        'An efficient sorting algorithm using partitioning to sort elements.',
  ...
  return [...quickSort(left), pivot, ...quickSort(right)];
    ...
    },
    {
      ...
      description:
        'An algorithm to find the shortest paths between all pairs of nodes in a graph.',
  ...
  return dist;
    ...
    },
    {
      ...
      description:
        'An algorithm to find the shortest paths in graphs that may have negative weight edges.',
  ...
  filterAlgorithms(): void {
    this.filteredAlgorithms = this.algorithms.filter(
      (algorithm) =>
